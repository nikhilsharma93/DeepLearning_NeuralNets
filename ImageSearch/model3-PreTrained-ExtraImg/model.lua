...
modelPreTrained = torch.load('modelPreTrained.net')
...
model:share(modelPreTrained,'weight','bias')
print ('pretrained: ', (modelPreTrained.modules[1]).modules[1].bias[{{1,3}}])
print ('new: ', (model.modules[1]).modules[1].bias[{{1,3}}])
